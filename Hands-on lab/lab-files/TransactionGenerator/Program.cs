    ...
    internal class Program
    {
                        ...
                        int MillisecondsToLead) ParseArguments()
        {
            try
            {
                ...
                return (eventHubConnectionString, eventHub2ConnectionString, eventHub3ConnectionString, cosmosDbEndpointUrl, cosmosDbAuthorizationKey, numberOfMillisecondsToRun, numberOfMillisecondsToLead);
            }
            catch (Exception e)
            {
        ...
        public static void Main(string[] args)
        {
            ...
            using (_cosmosDbClient = new DocumentClient(new Uri(arguments.CosmosDbEndpointUrl), arguments.CosmosDbAuthorizationKey, connectionPolicy))
            {
                ...
                SendData(paymentRecords, eventHubClients, 100, taskWaitTime, cancellationToken, progress).Wait();
            }
